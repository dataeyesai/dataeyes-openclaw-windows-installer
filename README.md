# DataEyes OpenClaw Windows Installer

DataEyes OpenClaw 的 Windows 安装包分发仓库。
...
- 详细版目录页：[Windows 一键安装使用教程](使用教程/README.md)
...
- 发布方式：GitHub Release 附件
- 当前文件名：`openclaw.windows.exe`
- 当前发布时间：`2026-03-23`

后续如果有新版本，直接继续在 Releases 中上传新的 `.exe` 即可。
